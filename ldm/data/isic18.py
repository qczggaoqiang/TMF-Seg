...
class ISIC18Train(ISIC18Base):
    def __init__(self, train_dir=r"D:\GQiang666\SDSeg_Gaoqiang\data\isic2018\train\images", **kwargs):
        super().__init__(train_dir=train_dir, val_dir=None, test_dir=None, mode="train", **kwargs)


class ISIC18Validation(ISIC18Base):
    def __init__(self, val_dir=r"D:\GQiang666\SDSeg_Gaoqiang\data\isic2018\val\images", **kwargs):
        super().__init__(train_dir=None, val_dir=val_dir, test_dir=None, mode="val", **kwargs)


class ISIC18Test(ISIC18Base):
    def __init__(self, test_dir=r"D:\GQiang666\SDSeg_Gaoqiang\data\isic2018\val\images", **kwargs):
