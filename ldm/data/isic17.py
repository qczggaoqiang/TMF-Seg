...
class ISIC17Base(Dataset):
    ...
    def __getitem__(self, i):
        ...
        segmentation = Image.fromarray(cv2.cvtColor(cv2.imread(example["file_path_"].replace("images", "masks").replace(".jpg", "_segmentation.png")), cv2.COLOR_BGR2RGB))
...
class ISIC17Train(ISIC17Base):
    def __init__(self, train_dir=r"D:\GQiang666\SDSeg_Gaoqiang\data\isic2017\train\images", **kwargs):
        super().__init__(train_dir=train_dir, val_dir=None, test_dir=None, mode="train", **kwargs)


class ISIC17Validation(ISIC17Base):
    def __init__(self, val_dir=r"D:\GQiang666\SDSeg_Gaoqiang\data\isic2017\val\images", **kwargs):
        super().__init__(train_dir=None, val_dir=val_dir, test_dir=None, mode="val", **kwargs)


class ISIC17Test(ISIC17Base):
    def __init__(self, test_dir=r"D:\GQiang666\SDSeg_Gaoqiang\data\isic2017\val\images", **kwargs):
